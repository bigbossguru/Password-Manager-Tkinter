...
class HomePageView(BasePageInterface):
    ...
    def __init__(self, mainframe: tk.Frame, *args, **kwargs) -> None:
        BasePageInterface.__init__(self, mainframe, *args, **kwargs)

        home_label = tk.Label(self, text='Home page', font=('Helvetica', 15))
        ...
        sing_in_btn.pack(side='top', fill='both', expand=True, padx=5, pady=5)
        sing_up_btn.pack(side='top', fill='both', expand=True, padx=5, pady=5)
...
class SingInPageView(BasePageInterface):
    ...
    def __init__(self, mainframe: tk.Frame, *args, **kwargs) -> None:
        ...
        home_btn.pack(side='top', fill='both', expand=True, padx=5, pady=5)
